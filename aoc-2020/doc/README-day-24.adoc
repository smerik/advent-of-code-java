== Day 24: Lobby Layout
:uri-hex-grid: https://en.wikipedia.org/wiki/Hexagonal_tiling
:uri-aoc-puzzle-input: https://adventofcode.com/2020/day/24/input
...
The tiles are all *hexagonal*; they need to be arranged in a {uri-hex-grid}[hex grid]
