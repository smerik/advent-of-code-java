== Day 22: Crab Combat
:uri-aoc-puzzle-input: https://adventofcode.com/2020/day/22/input
:uri-aoc-day-22: https://adventofcode.com/2019/day/22

It only takes a few hours of sailing the ocean on a raft for boredom to sink in.
Fortunately, you brought a small deck of {uri-aoc-day-22}[space cards]!
