...
:uri-rfid: https://en.wikipedia.org/wiki/Radio-frequency_identification
:uri-aoc-puzzle-input: https://adventofcode.com/2020/day/25/input
:uri-soft-serve: https://en.wikipedia.org/wiki/Soft_serve
...
The room key is a small {uri-rfid}[RFID] card.
...
"The {uri-soft-serve}[soft serve] machine in the cafeteria on sub-basement 7 just failed
